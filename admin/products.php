...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
    ...
    ';
      ...
      $insert_products = $con->prepare("INSERT INTO `products`(name, details, price, image_01, image_02, image_03) VALUES(?,?,?,?,?,?)");
...
if(isset($_GET['delete'])){
   ...
   $delete_wishlist = $con->prepare("DELETE FROM `wishlist` WHERE pid = ?");
